...
class QuizBrain {
  ...
  bool isRightAnswer(bool answer) =>
      _questions[_currentQuestion].isRightAnswer(answer);

  void resetQuiz() {
    _currentQuestion = 0;
    _recordedAnswer.clear();
  }

  void recordAnswer(bool answer) => _recordedAnswer.add(answer);
